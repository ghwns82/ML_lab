...
.field static final aeV:[Ljava/lang/String;

.field private static final aeW:Ljava/util/regex/Pattern;


# instance fields
.field private final aeX:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private final aeY:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field private final aeZ:Ljava/util/concurrent/locks/ReentrantLock;

.field private final afa:Ljava/util/LinkedList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final afb:Lcom/google/android/gms/tagmanager/DataLayer$c;

.field private final afc:Ljava/util/concurrent/CountDownLatch;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->aeV:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->aeW:Ljava/util/regex/Pattern;
...
.method constructor <init>(Lcom/google/android/gms/tagmanager/DataLayer$c;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afb:Lcom/google/android/gms/tagmanager/DataLayer$c;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeX:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeY:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeZ:Ljava/util/concurrent/locks/ReentrantLock;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afa:Ljava/util/LinkedList;
    ...
    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afc:Ljava/util/concurrent/CountDownLatch;

    invoke-direct {p0}, Lcom/google/android/gms/tagmanager/DataLayer;->lt()V
...
.method private A(Ljava/util/Map;)V
    ...
    iget-object v2, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afb:Lcom/google/android/gms/tagmanager/DataLayer$c;
...
.method private C(Ljava/util/Map;)Ljava/lang/Object;
    ...
    sget-object v2, Lcom/google/android/gms/tagmanager/DataLayer;->aeV:[Ljava/lang/String;
...
.method private E(Ljava/util/Map;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeY:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeY:Ljava/util/Map;
...
.method private F(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeX:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static synthetic a(Lcom/google/android/gms/tagmanager/DataLayer;)Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afc:Ljava/util/concurrent/CountDownLatch;
...
.method static bO(Ljava/lang/String;)Ljava/lang/Long;
    ...
    sget-object v1, Lcom/google/android/gms/tagmanager/DataLayer;->aeW:Ljava/util/regex/Pattern;
...
.method private lt()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afb:Lcom/google/android/gms/tagmanager/DataLayer$c;
...
.method private lu()V
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->afa:Ljava/util/LinkedList;
...
.method private z(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeZ:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/tagmanager/DataLayer;->lu()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeZ:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeY:Ljava/util/Map;

    monitor-enter v4

    :try_start_0
    iget-object v2, p0, Lcom/google/android/gms/tagmanager/DataLayer;->aeY:Ljava/util/Map;
